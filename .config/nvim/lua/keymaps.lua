...
vim.keymap.set('n', lsp_leader..'i', function() vim.lsp.buf.implementation()                  end, {desc = "Go to Implementation"})
vim.keymap.set('n', lsp_leader..'i', function() vim.lsp.buf.implementation()                  end, {desc = "Go to Implementation"})
...
vim.keymap.set('n', lsp_leader..'t', function() vim.lsp.buf.type_definition()                 end, {desc = "Type Definition"})
